...
const isOwner = [`${setting.ownerNumber}`,"6282133650902@s.whatsapp.net","6282133650902@s.whatsapp.net"].includes(sender) ? true : false
...
"fileName": `SifaBot-MD ${ngazap(prefix)}`,
